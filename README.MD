...
On The Papers with Code, we set up [mutlilingual image-text classification benchmark](https://paperswithcode.com/sota/multi-lingual-image-text-classification-on).
